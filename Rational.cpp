...
int main1()
{
    ...
    cout << "Rezultatul adunarii este: " << r.add_rational(n1, d1, n2, d2);
    cout << "Rezultatul inmultirii este: " << r.mul_rational(n1, d1, n2, d2);
    cout << "Rezultatul impartirii este: " << r.div_rational(n1, d1, n2, d2);
